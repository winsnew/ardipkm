...
const Sidebar = () => {
  ...
  return (
    <div className={`min-h-screen bg-blue-600 ${isSidebarOpen ? "sidebar-open" : ""}`}>
      <span
      ...
      <div
        className={`sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900 ${isSidebarOpen ? "" : "hidden"}`}
      >
